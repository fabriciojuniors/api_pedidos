...
import com.api_pedidos.dto.ProdutoDTO;
import com.api_pedidos.resources.utils.URL;
import com.api_pedidos.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage( @RequestParam(value="page", defaultValue = "0") Integer page, 
		...
		Page<ProdutoDTO> listDO = list.map(obj -> new ProdutoDTO(obj));
